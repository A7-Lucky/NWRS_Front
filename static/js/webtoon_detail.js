...
async function loadWebtoonReview(webtoon_id){
    ...
    reviews.forEach(review => {
        ...
        update_review_button.setAttribute("onclick", "UpdateWebtoonreview(this.id)")
        delete_review_button.setAttribute("onclick", "DeleteWebtoonreview(this.id)")
...
async function UpdateWebtoonreview(review_id) {
    ...
    update_review_button.setAttribute("onclick", "handleUpdateWebtoonreview(this.id)")
